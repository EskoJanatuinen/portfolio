  ...
  return (
    ...
    <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
        ...
        <Link href={projectUrl}>
            <p className='text-center mx-3 py-1 sm:mx-0 sm:py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer hover:scale-110 ease-in duration-300'>Info</p>
        </Link>
    </div>
 </div>
  )
